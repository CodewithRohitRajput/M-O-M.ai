...
5. Configure environment variables:
   - Create a `.env` file in the project root with the following content:
     ...
     # Audio Configuration
     SAMPLE_RATE=44100
     MAX_AUDIO_SIZE_BYTES=209715200
...
| MAX_AUDIO_SIZE_BYTES | Audio above this size is trimmed before upload | 209715200 (200MB) |
| GEMINI_API_KEY | Your Google Gemini API key | - |
| GEMINI_MODEL | Gemini model used for transcription and analysis | gemini-2.5-flash |

## Features

- Automated Google Meet login and joining
- Audio recording of meetings
- Transcription using Google Gemini
